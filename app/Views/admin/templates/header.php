...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/jquery-date-range-picker/0.21.1/daterangepicker.css">
  <style>
    #TransactionHistory_filter {
      margin-bottom: 10px !important;
    }

    #TransactionHistory_filter input {
        ...
        <div class="navbar-header">
          ...
          <span class="float-end me-5">
            <div class="dropdown dropstart">
              <span class="text-white">Welcome, <?php echo session()->fname_admin . " " . session()->lname_admin; ?>!</span>
              ...
              <ul class="dropdown-menu" aria-labelledby="user_menu">
                <li>
                  <a class="dropdown-item" href="#">
                    <?php echo session()->fname_admin . " " . session()->lname_admin; ?>
                  </a>
                </li>
                <li>
                  <a class="dropdown-item" href="#">
    ...
    <nav class="navbar-default navbar-side" role="navigation" id="dropdown">
      <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
          ...
          <div class="row">
            <div class="col-md-12">
              <li class="nav-item side-link <?php if (uri_string() == "admin") {
                                              echo "active-link";
                                            } ?>">
            ...
            <div class="col-md-12">
              <div class="dropdown dropend">
                <a href="#packages" class="<?php if (uri_string() == "admin/packages" || uri_string() == "admin/packages/active_packages") {
                                              echo "active-link";
                                            } ?> nav-link" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false"><i class="fa fa-calendar"></i> Packages <span class="badge"></span></a>
            ...
            <div class="col-md-12">
              <div class="dropdown dropend">
                <a href="#comments" class="<?php if (uri_string() == "admin/comments/blog" || uri_string() == "admin/comments/package") {
                                              echo "active-link";
                                            } ?> nav-link" id="comments_dropdown" data-bs-toggle="dropdown" aria-expanded="false"><i class="fa fa-comment"></i> Comments</a>
            ...
            <div class="col-md-12">
              <div class="dropdown dropend">
                <a href="#comments" class="<?php if (uri_string() == "admin/transaction_history") {
                                              echo "active-link";
                                            } ?> nav-link" id="comments_dropdown" data-bs-toggle="dropdown" aria-expanded="false"><i class="fa fa-comment"></i> Transaction History</a>
                <ul class="dropdown-menu" aria-labelledby="post_dropdown" style="width: 100%;">
                  <li class="nav-item side-link">
