<div id="page-wrapper" >
    <div id="page-inner">
        <div class="row">
            <div class="col-md-12">
             <h2>Packages <a class="btn btn-light add-new-btn" href="packages/add_package">Add New</a></h2>
            </div>
        </div>
          <hr />
                ...
                <table class="table table-hover table-bordered">
                 ...
                 <tbody>
                   ...
                   <tr>
                     ...
                     <td class=""><?php if($package['status'] == "Available"){ ?><img src="<?php echo base_url('assets/photo/images/icons/avail.png'); ?>" style="width: 10%;">
                     <?php }elseif($package['status'] == "Unavailable"){
                       ?><img src="<?php echo base_url('assets/photo/images/icons/unavail.png'); ?>" style="width: 10%;"><?php
                     } ?></td>
                     <td>
