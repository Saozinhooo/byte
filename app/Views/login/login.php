        ...
        <div class="login-content">
            <form id="login_form" method="post" action="<?php echo site_url("login/auth"); ?>">
                ...
                <?php if (session()->getFlashdata('failed')) : ?>
                    <div class="alert alert-success"><?= session()->getFlashdata('failed') ?></div>
                <?php endif; ?>
                <?php if (session()->getFlashdata('no_token')) : ?>
                    <div class="alert alert-success"><?= session()->getFlashdata('no_token') ?></div>
                <?php endif; ?>
